class BNGInfo:
    ...
    def gatherInfo(self):
        ...
        # Get BNG version
        with open(os.path.join(*[os.path.dirname(bionetgen.__file__), "assets", "BNGVERSION"]), "r") as f:
            read_data = f.read()
        ...
        # Get CLI version
        with open(os.path.join(*[os.path.dirname(bionetgen.__file__), "assets", "VERSION"]), "r") as f:
            read_data = f.read()
