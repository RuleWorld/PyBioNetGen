...
def defineConsole():
    ...
    parser.add_argument(
        ...
        action="store_true",
        help=(
            "use SBML molecule ids instead of names. IDs are less "
            "descriptive but more bngl friendly. Use only if the generated "
            "BNGL has syntactic errors"
        ),
    )
    parser.add_argument(
    ...
    parser.add_argument(
        ...
        "--biogrid",
        action="store_true",
        help="Use biogrid database to infer molecules",
    )
    return parser
